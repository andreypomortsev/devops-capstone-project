...
class TestAccountService(TestCase):
    ...
    def test_security_headers(self):
        ...
        headers = {
            ...
            "Content-Security-Policy": "default-src 'self'; object-src 'none'; script-src 'self' 'unsafe-inline' 'unsafe-eval'",
            "Referrer-Policy": "strict-origin-when-cross-origin",
            # "X-XSS-Protection": "1; mode=block", due to its outdated status I changed it to CSP
        }
